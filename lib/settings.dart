...
class TelemedStrings{
  ...
  static String phoneNote = "By providing your mobile number you give us permission to contact you via text.";
  static String healthInsurance = "Health Insurance";
  static String hInsurance= "Search for your heath insurance provider to see if you're cover";
  ...
  static String bookingNote = "Confirm a date and time for your appointment with a general practitioner. Include a note as well";
  ...
  static String hpText = "Kindly provide the patient's medical information and history";
  ...
  static String hpQ3text1 = "Please consider any medications you are currently taking, including those taken in a regular basis.";
  ...
  static String hpQ5 = "Do you have any medical conditions? Example: High Cholesterol, Insomnia, Asthma";
  static String hpQ6 = "Have you had any surgeries? Examples: Appendectomy, Tonsillectomy, Knee replacement.";
  static String hpQ7 = "Has anyone in your family had any medical conditions? Please only include first-degree relatives (parents, siblings, and children)";
  ...
  static String reviewprofileText = "Mase sure all details are correct as these information would aid the Medical Practitioner";
